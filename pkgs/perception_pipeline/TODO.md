...
- [ ] Plug OpenCV into scaffolding done in step 2 
    ...
    - [ ] Integrate it via having it run in its own thread
    - [ ] Add a test path to enable it via the web ui (this means the server would need to own an OrderSender so we should probably take it out later) 
- [ ] Bottlecap targeting
